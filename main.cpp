...
int main() {
    ...
    cout << m1 / m2 << endl;
    Polynomial<Monomial<Fraction<int64_t>>, MonomialOrders::Lex> pp("abd + c");
    cout << pp << endl;
    ...
    Polynomial<Monomial<Fraction<int64_t>>> p("\\frac{-16}{-8}xxxyyyzzz - \\frac{1}{2}x^2y^3z^3U_83242348^123123 + 100h");
    cout << endl;
    cout << p << endl;
    cout << (5 * p * 6) * p << endl;
    cout << endl;
    using monom1 = Monomial<Fraction<int64_t>, VariableOrders::InverseAsciiOrder>;
    Polynomial<monom1, MonomialOrders::Grlex> p1("x_1x_2x_3");
    Polynomial<monom1, MonomialOrders::Grlex> p2("x_1x_3-x_4");
    p2.do_one_elementary_reduction_over(p1);
    cout << p1 << endl;
    cout << endl;

    Ideal<Polynomial<monom1, MonomialOrders::Grlex>> kek;
    kek.insert("x_1x_2-x_4");
    kek.insert("x_1x_3-x_4");
    kek.make_groebner_basis();
    cout<<kek<<'\n';
    kek.make_minimal_groebner_basis();
